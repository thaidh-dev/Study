<%-- 
    Document   : DangKy
    Created on : Aug 4, 2019, 9:17:42 PM
    Author     : Admin
--%>
...
<html>
    <head>
        ...
        <title>Đăng ký tài khoản Mendover</title>
            ...
            <div id="banner">
                ...
                <div class="bannerCon">
                    ...
                    <ul>
                        ...
                        <li style="color: #caa87f">Đăng ký tài khoản</li>
                    </ul>
                    <div class="dangNhap">
                        <form action="DangKy" method="post">
                            <span class="titleDangNhap">ĐĂNG KÝ THÔNG TIN TÀI KHOẢN</span> <br>
                            <input type="text" placeholder="Họ tên:*" required class="text" name="txtHoTen" maxlength="50"> <br>
                            <input type="email" placeholder="Email:*" data-validation="email" required value class="text" name="txtEmail" maxlength="50"> <br>
                            <input type="password" placeholder="Mật khẩu:*" required class="text" style="margin-bottom: 25px" name="txtMatKhau" maxlength="20"> <br>
                            <input type="submit" value="ĐĂNG KÝ" class="submit" name="submit">
                        </form>
                    </div>
                </div>	
            </div>
