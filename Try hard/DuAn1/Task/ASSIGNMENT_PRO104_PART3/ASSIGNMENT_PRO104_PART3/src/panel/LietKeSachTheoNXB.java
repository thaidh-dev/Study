...
public class LietKeSachTheoNXB implements Khung {
    JPanel pnlThan, pnlThan2, pnlChucNang, pnlTieuDe_ChucNang;
    JTable tbl;
    JScrollPane scr;
    JLabel lblTieuDe, lblNXB;
    JComboBox cboNXB;
    JButton btnKetXuat;
    ...
    public void taoDoiTuong() {
        ...
        lblTieuDe = new JLabel("Liệt kê sách theo nhà xuất bản");
...
//        txtCbo = (JTextField) cboNXB.getEditor().getEditorComponent();
    ...
    public void taoDang() {
        ...
        cboNXB.setPreferredSize(new Dimension(200, 25));
    ...
    @Override
    public void event() {
        cboNXB.addItemListener(new ItemListener() {
            @Override
        ...
        btnKetXuat.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (cboNXB.getSelectedItem() == null || cboNXB.getSelectedItem().equals("")) {
                    JOptionPane.showMessageDialog(pnlThan, "Vui lòng chọn một nhà xuất bản", "Lưu ý", 2);
                }
                else {
                    if (tbl.getRowCount() == 0) {
                        ...
                        XSSFSheet sheet = workbook.createSheet("Liệt kê sách theo nhà xuất bản");
                        ...
                        c0r1.setCellValue("Bảng liệt kê sách theo nhà xuất bản");
                        ...
                        c0r2.setCellValue("Nhà xuất bản: " + cboNXB.getSelectedItem());
                        ...
                        try {
                            ...
                            String tenFile = "Liệt kê sách theo nhà xuất bản - " + System.currentTimeMillis() + ".xlsx";
    ...
    @Override
    public void add() {
        JComponent a[] = {lblNXB, cboNXB, btnKetXuat};
    ...
    public void fillToTable() {
        List<Sach> lstSach = sachDAO.lietKeSachTheoNXB((String) cboNXB.getSelectedItem());
    ...
    public void addItems() {
        cboNXB.setEditable(false);
        cboNXB.removeAllItems();
        
        List<NhaXuatBan> lstNXB = nxbDAO.select();
