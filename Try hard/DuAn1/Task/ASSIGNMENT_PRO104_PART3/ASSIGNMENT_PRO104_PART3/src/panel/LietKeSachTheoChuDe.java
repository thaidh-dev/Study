...
public class LietKeSachTheoChuDe implements Khung {
    JPanel pnlThan, pnlThan2, pnlChucNang, pnlTieuDe_ChucNang;
    JTable tbl;
    JScrollPane scr;
    JLabel lblTieuDe, lblChuDe;
    JComboBox cboChuDe;
    JButton btnKetXuat;
    ...
    public void taoDoiTuong() {
        ...
        lblTieuDe = new JLabel("Liệt kê sách theo chủ đề");
...
//        txtCbo = (JTextField) cboChuDe.getEditor().getEditorComponent();
    ...
    public void event() {
        ...
        btnKetXuat.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (cboChuDe.getSelectedItem() == null || cboChuDe.getSelectedItem().equals("")) {
                    JOptionPane.showMessageDialog(pnlThan, "Vui lòng chọn một chủ đề", "Lưu ý",2);
                }
                else {
                    if (tbl.getRowCount() == 0) {
                        ...
                        XSSFSheet sheet = workbook.createSheet("Liệt kê sách theo chủ để");
                        ...
                        c0r1.setCellValue("Bảng liệt kê sách theo chủ đề");
                        ...
                        c0r2.setCellValue("Chủ đề: " + cboChuDe.getSelectedItem());
                        ...
                        try {
                            ...
                            String tenFile = "Liệt kê sách theo chủ đề - " + System.currentTimeMillis() + ".xlsx";
    ...
    @Override
    public void add() {
        JComponent a[] = {lblChuDe, cboChuDe, btnKetXuat};
    ...
    public void fillToTable() {
        List<Sach> lstSach = sachDAO.lietKeSachTheoChuDe((String) cboChuDe.getSelectedItem());
    ...
    public void addItems() {
        cboChuDe.setEditable(false);
        cboChuDe.removeAllItems();
        List<ChuDe> lstChuDe = cdDAO.select();

        for (ChuDe cd : lstChuDe) {
            cboChuDe.addItem(cd.getTenCD());
        }
