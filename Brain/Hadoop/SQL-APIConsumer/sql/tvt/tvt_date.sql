...
drop table mdo_tvt_date
go

create table mdo_tvt_date(
	...
	V_SD_RT						float,
	V_LD_RT						float
	unique(date_id, ttml, dvt, tvt)
)
go


alter proc sp_mdo_tvt_date
	@offset int = 0, 
	@limit int = 100, 
	@acceptPartial bit = 0,
...
GROUP BY
	...
	MERGE mdo_tvt_date AS Target
	USING (
		select date_id, isnull(ttml, '') ttml, isnull(dvt, '') dvt, isnull(tvt, '') tvt,  
	...
	WHEN NOT MATCHED BY TARGET THEN
		...
		values (
			Source.DATE_ID, Source.TTML, Source.DVT, Source.TVT, Source.WEB_TOTAL, 
...
exec sp_mdo_tvt_date 0, 7, 1, 'noc_mdo', default, default, default, default 
exec sp_mdo_tvt_date 0, 7, 1, 'noc_mdo', default, default, 'dsdsdsds', 'dsdsdsds'
exec sp_mdo_tvt_date 0, 7, 1, 'noc_mdo', default, default, 'DVT Da Nang', 'TVT Da Nang 2' 
exec sp_mdo_tvt_date 0, 7, 1, 'noc_mdo', default, default, null, 'TVT Da Nang 2'

select * from mdo_tvt_date
