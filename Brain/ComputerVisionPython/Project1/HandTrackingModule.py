...
class handDetector():
    ...
    def findPosition(self, img, handNo=0, draw=True, *lmPoint):
        self.lmList = []
        if self.results.multi_hand_landmarks:
...
def main():
    ...
    while cap.isOpened():
        ...
        detector.findPosition(img, 0, True, 4, 8)
