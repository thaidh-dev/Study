...
GROUP BY
	...
	MERGE mdo_cell_hour AS Target
	USING (
		select datetime_id, isnull(ttml, '') ttml, isnull(noc, '') noc, isnull(province, '') province, isnull(district, '') district, 
	...
	WHEN NOT MATCHED BY TARGET THEN
		insert (
			DATETIME_ID, TTML, NOC, PROVINCE, DISTRICT, SITENAME, CELL_NODE_ID, 
			WEB_TOTAL, MDO_VIDEO_COUNT, WEB_RESP_SUCC, WEB_AVG_RESP_DELAY, WEB_AVG_DISPLAY_DELAY, WEB_DL_TIME, WEB_DL_DATA, WEB_BROWS_SUCC, 
			WEB_BROWS_TOTAL, VIDEO_STREAM_SUCC, VIDEO_STREAM_TOTAL, VIDEO_STREAM_START_DELAY, VIDEO_STREAM_STALL, VIDEO_STREAM_DATA, VIDEO_STREAM_TIME, 
			VIDEO_HD_NUM, VIDEO_SD_NUM, VIDEO_LD_NUM, HTTPS_WEB_DL_DATA, HTTPS_WEB_DL_TIME, HTTPS_VIDEO_STREAM_DATA, HTTPS_VIDEO_STREAM_TIME, 
		...
		values (
			Source.DATETIME_ID, Source.TTML, Source.NOC, Source.PROVINCE, Source.DISTRICT, Source.SITENAME, Source.CELL_NODE_ID, Source.WEB_TOTAL, 
...
drop table mdo_cell_hour
go

create table mdo_cell_hour(
	...
	V_SD_RT float,  
	V_LD_RT float
	unique(datetime_id, ttml, noc, province, district, sitename, cell_node_id)
)
go
...
exec sp_mdo_cell_hour 0, 7, 1, 'noc_mdo', default, default, default, default, default, default, default 
exec sp_mdo_cell_hour 0, 7, 1, 'noc_mdo', default, default, default, default, 'Qui Nhon', 'BDQN22', 1307104 
exec sp_mdo_cell_hour 0, 7, 1, 'noc_mdo', default, default, default, default, null, 'BDQN22', 1307104 

select * from mdo_cell_hour
