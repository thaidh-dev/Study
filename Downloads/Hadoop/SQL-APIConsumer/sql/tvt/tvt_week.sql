...
drop table mdo_tvt_week
go

create table mdo_tvt_week(
	...
	V_SD_RT						float,
	V_LD_RT						float
	unique(week_id, ttml, dvt, tvt)
)
go


ALTER proc sp_mdo_tvt_week
	@offset int = 0, 
	@limit int = 100, 
	@acceptPartial bit = 0,
...
GROUP BY
	...
	MERGE mdo_tvt_week AS Target
	USING (
		select week_id, isnull(ttml, '') ttml, isnull(dvt, '') dvt, isnull(tvt, '') tvt,  
	...
	WHEN NOT MATCHED BY TARGET THEN
		...
		values (
			Source.WEEK_ID, Source.TTML, Source.DVT, Source.TVT, Source.WEB_TOTAL, 
...
exec sp_mdo_tvt_week 0, 7, 1, 'noc_mdo', default, default, default, default 
exec sp_mdo_tvt_week 0, 7, 1, 'noc_mdo', default, default, 'dsdsdsds', 'dsdsdsds'
exec sp_mdo_tvt_week 0, 7, 1, 'noc_mdo', default, default, 'DVT Binh Dinh', 'TVT Binh Dinh' 
exec sp_mdo_tvt_week 0, 7, 1, 'noc_mdo', default, default, null, 'TVT Binh Dinh'

select * from mdo_tvt_week
